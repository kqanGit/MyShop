...
exports.seed = async function(knex) {
  ...
  await knex('Voucher').insert([
    { voucher_id: 1, voucher_code: "CHAOBANMOI", description: "Giảm 10k cho đơn đầu tiên", type: 2, discount: 10000, min_threshold: 50000, start_date: '2024-01-01', end_date: '2026-12-31', is_removed: 0 },
